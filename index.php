...
<div class="container">		
	...
	<?php } else { ?>
		<br>
		<br>
		<strong><a href="login.php"><h3>Back to login page</h3></a></strong>		
	<?php } ?>
	<br>
	<br>	
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="http://github.com/G-Shivam">Visit My Work</a>		
	</div>	
</div>	
